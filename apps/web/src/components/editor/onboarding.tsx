				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to BASE! 🎉" />
							<Description description="Добро пожаловать в BASE — мобильный видеоредактор прямо в браузере." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Join our [Discord](${SOCIAL_LINKS.discord}), chat with cool people and share feedback to help make BASE the best editor ever.`}
							/>
						</div>
